...
<div class="flex-grid demo-grid ">
	<div class="row flex-just-center margin40 ">
        ...
        <div class='cell'> <img src="/vox/nba/public/images/players/<?= $player[0]->picture ?>"> </div>
			 <form method="POST" action="/vox/nba/admin/player/edit" enctype="multipart/form-data">
