	 		 			 ...
	 		 			 <div id='cover' class="row cells12" >
            			 	...
            			 	<div class="cell colspan9 fg-white "  >
            			 		...
            			 		<h3  ><b><?= $player[0]->lastname; ?> </b></h3>
            			 			...
            			 			<!-- edit player -->
            			 		<a href="/vox/nba/admin/player/edit/<?= $player[0]->firstname;?>/<?= $player[0]->id_player ?>" class="place-right fg-white"><span class="mif-pencil"></span> EDIT </a>
            			 		 <a onclick="metroDialog.toggle('#dialogaddvideo')" class='place-right fg-white'> <span class="mif-plus prepend-icon"></span> Add Video</a>
            			 		 <form action="/vox/nba/admin/player/delete" method="POST">
...
<script type="text/javascript">
    var string='/vox/nba/admin/players/all';
	...
	$("#search").keyup(function(){
        ...
        if (!bla){
            ...
            var string='/vox/nba/admin/players/search/'+bla;
         $( "#searchlist" ).load( string );
	});
